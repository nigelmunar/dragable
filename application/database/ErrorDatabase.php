<?php
    ...
    require_once ROOT_PATH . 'application/utilities/MemcachedCacher.php';
    ...
    class ErrorDatabase
    {
        ...
        public function getErrors(int $start, int $length, array $sortOrder = []) : array 
        {
            ...
            {
                $cachedValue = \MemcachedCacher::getCache($key);
                ...
                {*/
                    ...
                    /*$this->errorResults[$key] = $results;
                     \MemcachedCacher::setCache($key, json_encode($this->administratorResults[$key]), ERROR_CACHE_SECONDS, "Errors");*/
                //}
